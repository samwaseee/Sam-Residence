...
const Explore = () => {
    return (
        <>
            <div className='mt-32 max-w-5xl mx-auto flex'>
                <img src="https://lasvegas.wpresidence.net/wp-content/uploads/2022/03/team2.jpeg" data-aos="fade-right" className='rounded-2xl' />
